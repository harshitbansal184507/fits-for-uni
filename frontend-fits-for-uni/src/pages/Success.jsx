...
const Success = () => {
  ...
  return (
    <div className='m-2 w-full max-w-md bg-red-200 p-4 py-5 rounded mx-auto flex flex-col justify-center items-center gap-5 dark:text-white dark:bg-gray-700'>
